...
void nodeHal_saadc_sampling_event_enable(void)
{
...
void nodeHal_saadc_sampling_event_init(void)
{
    ret_code_t err_code;
...
void nodeHal_saadc_init(void* saadc_callback)
{
    ret_code_t err_code;
    ...
    // nodeHal_saadc_sampling_event_init();
    // nodeHal_saadc_sampling_event_enable();
}


void nodeHal_saadc_init_simple(void)
{
...
void nodeHal_saadc_sample_simple(nrf_saadc_input_t saadc_pin, int16_t* result_ptr)
{
